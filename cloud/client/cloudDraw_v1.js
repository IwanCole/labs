...
function draw_start(e, touches) {
    ...
    for (var i = 0; i < touches.length; i++) {
        ...
        ctx.beginPath();
        ctx.arc(touches[i].pageX, touches[i].pageY, _LINEWIDTH/2, 0, 2 * Math.PI, false);
...
function init() {
    ...
    if (mobileDevice) {
        canvas.addEventListener('touchstart', (e) => {
            ...
            draw_start(e, scaleCoords([touchObj]));
        });
        canvas.addEventListener('touchmove', (e) => {
            ...
            draw_move(e, scaleCoords([touchObj]));
        });
        canvas.addEventListener('touchend', (e) => {
            ...
            draw_end(e, scaleCoords([touchObj]));
